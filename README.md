...
- `liked_post_hour_cumulative_likes_*.parquet` stores sparse prior-hour popularity curves for final liked/history posts only. It is used by Stage 2 history features, not sampled negatives.
